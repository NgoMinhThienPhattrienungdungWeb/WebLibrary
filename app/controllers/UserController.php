    ...
    public function Controllers()
    {
        ...
        switch ($page) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if ($input_valid) {
                        if (isset($_POST['submit_login'])) {
                            ...
                            $admin = $this->user->login($idlogin, $pass);
                            if (!empty($admin)) {
            ...
            case 'user_add_input':
                ...
                $valid = true;
                $checkupload = true;
                $checkuserid = $this->user->getUserId();
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            case 'user_add_confirm':
                ...
                if (isset($_POST['submit_add_complete'])) {
                    ...
                    $add_user = $this->user->addUser($type, $name, $userid, $avatar, $description, $updated);
                    if ($add_user) {
                        ...
                        $update_avatar = $this->user->updateAvatar($avatar, $cusID);
                        if ($update_avatar) {
